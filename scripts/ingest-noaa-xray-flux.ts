/**
 * scripts/ingest-noaa-xray-flux.ts — manual ingest trigger for development.
 *
 * Runs the full NOAA X-ray flux pipeline: fetcher → normalizer → SQLite.
...
async function main(): Promise<void> {
  console.info("[helios] Fetching NOAA SWPC X-ray flux (GOES)...");
