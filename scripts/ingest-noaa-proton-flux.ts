/**
 * scripts/ingest-noaa-proton-flux.ts — manual ingest trigger for development.
 *
 * Runs the full NOAA proton flux pipeline: fetcher → normalizer → SQLite.
...
async function main(): Promise<void> {
  console.info("[helios] Fetching NOAA SWPC proton flux (GOES)...");
